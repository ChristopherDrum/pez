...
void set_table(TABLE_INFO *info)
{
	unsigned char i;
...
TABLE_INFO *new_table(unsigned char type, UBYTE space)
{
	TABLE_INFO *n_table;
...
void set_els(unsigned char type, unsigned char space, unsigned short size)
{
