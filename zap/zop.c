...
int zo_0op( ODDISP *ocP ) /* Ptr to opcode data */
{
...
int zo_1op( ODDISP *ocP )/* Opcode data ptr */
{
		int		sts;
		UBYTE		opcode;		/* Opcode value */
...
int zo_2op( ODDISP *ocP )/* Opcode data ptr */
{
		int		sts;
	int		maxargs;
...
int zo_xop( ODDISP *ocP )/* Opcode data ptr */
{
...
int zo_call( ODDISP *ocP ) /* Opcode data ptr */
{
...
int zo_icall( ODDISP *ocP ) /* Opcode data ptr */
{
...
int zo_gxop( ODDISP *ocP, int mdelta )
...
int zo_printi( ODDISP *ocP )/* Opcode data ptr */
{
		int		sts;
...
static int zo_eol( ODDISP *ocP ) /* Ptr to opcode data */
{
		int		sts;
...
static int zo_val( ODDISP *ocP )/* Opcode data ptr */
{
		int		sts;
...
static int zo_pred( ODDISP *ocP ) /* Opcode data ptr */
{
		int		sts;
