...
cosmocc -o mkcomptime mkcomptime.c
...
function make_o_files {
	...
	for element in "${arr[@]}"; do
		...
		cosmocc -g -c -o "$element.o" "$element.c"
	done
}

zap_files=("zap" "zasm" "zdir" "zop" "zlabel" "zeval" "zfixup" "zerror" "zlex" "zsymtab" "zobj" "zstring" "zsymout" "ztable" "zsegment" "ALLOC" "resfile" "zapres" "zdata")
